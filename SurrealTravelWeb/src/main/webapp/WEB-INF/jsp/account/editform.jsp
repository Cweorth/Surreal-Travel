...
<table border="0" cellpadding="0" cellspacing="0" class="tableForm">
    <tr>
        ...
        <td><form:checkbox path="customer" id="customer" state="off"/></td>
    </tr>
    <tr>
        <td class="left">* <f:message key="customer.name"/>:</td>
        <td>
            <form:input id="customer-name" path="account.customer.name" cssClass="text" readonly="true"/>
        </td>
    </tr>
    <tr>
        <td class="left">* <f:message key="customer.address"/>:</td>
        <td>
            <form:input id="customer-address" path="account.customer.address" cssClass="text" readonly="true"/>
        </td>
    </tr>
</table>
