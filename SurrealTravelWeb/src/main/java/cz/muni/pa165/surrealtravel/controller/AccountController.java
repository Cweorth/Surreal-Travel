...
public class AccountController {
    ...
    public void initBinderEdit(WebDataBinder binder) {
        binder.setValidator(new AccountEditValidator());
    }
    ...
    public String newAccount(
        ...
        return "redirect:" + uriBuilder.path(resultStatus.equals("success") ? "/login" : "/accounts").queryParam("notification", resultStatus).build();
    }
